...
from Cura.gui import mkswifiPanel
...
class mainWindow(wx.Frame):
	def __init__(self):
		super(mainWindow, self).__init__(None, title='Cura - 15.04.6 - MKS')
...
class normalSettingsPanel(configBase.configPanelBase):
	...
	def __init__(self, parent, callback = None):
		...
		# #mkswifi page
		self.mkswifiPanel = mkswifiPanel.mkswifiPanel(self.nb, callback)
		self.nb.AddPage(self.mkswifiPanel, "MKSWIFI")
